#! /bin/sh
#
# run_epic_wp.sh            This application shell script takes care of directly
#                           starting and stopping epic_wp.
#

echo -e 'Version: $Id: run_epic.sh 0000 1900-01-01 00:00:00Z nemo $\n'
...
APP_CMD="${APP_BINDIR}/${APPN} ${APP_CFGDIR}/${APPN}.conf"
