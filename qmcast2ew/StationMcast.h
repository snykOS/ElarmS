...
typedef std::map<const char*, int, LessStr, std::allocator<std::pair<const char *, int> > >  Name2IntMap;
typedef std::map<const char*, char*, LessStr, std::allocator<std::pair<const char*, char* > > >  Name2NameMap;
