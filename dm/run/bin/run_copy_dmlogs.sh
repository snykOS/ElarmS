#! /bin/sh
#
# copy_dmlogs       This application shell script takes care of directly
#                   starting and stopping copy_dmlogs
#
RETVAL=0
...
APP="copy_dmlogs"
APP_DIR="/app/dm"
APP_RUNDIR="${APP_DIR}/run"
APP_BINDIR="${APP_RUNDIR}/bin"
APP_CFGDIR="${APP_RUNDIR}/params"
APP_LOGDIR="${APP_RUNDIR}/logs"
APP_CMD="/usr/bin/java -cp /app/amq/run/bin/eew.jar:/app/amq/run/lib/*:/app/amq/run/lib/optional/* eew.senders.CopyDayFiles ${APP_CFGDIR}/copy_dmlogs.conf"
APP_LOG="/app/share/bin/conlog ${APP_LOGDIR}/${APP}"
